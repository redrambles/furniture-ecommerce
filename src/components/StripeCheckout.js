...
const CheckoutForm = () => {
	...
	const createPaymentIntent = async () => {
		try {
			...
			console.log(data.clientSecret); // You can go see this in the browser
			setClientSecret(data.clientSecret);
		} catch (err) {
			// the 'err.response' is axios
	...
	const handleChange = async (event) => {
		// The value for our state pieces here is coming from the Stripe API
